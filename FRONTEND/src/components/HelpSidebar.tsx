...
const HelpSidebar: FC<Props> = ({ page, setPage, setFeature, feature }) => {
	const [showFeaturesDropdown, setShowFeaturesDropdown] = useState<boolean>(false);
	const [showIntroDropdown, setShowIntroDropdown] = useState<boolean>(false);
